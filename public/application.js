...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  currentPlayer = 'x'.catch(ui.createGameFailure);
	};
	...
	var onDispLayOneGame = function onDispLayOneGame(event) {
	  event.preventDefault();
	  console.log('display one game was clicked');
	  var data = getFormFields(data);
	  api.displayOneGame(data).then(ui.displayOneGameSuccess).catch(ui.displayOneGameFailure);
	};
	...
	var onClickBoard = function onClickBoard(event) {
	  ...
	  if (currentPlayer === 'x') {
	    ...
	    var _over = isOver(gameBoard, value);
	    console.log('over equals ' + _over);
	    var data = {
	      'game': {
	        'cell': {
	          'index': +index,
	    ...
	    var _over2 = isOver(gameBoard, value);
	    var _data = {
	      'game': {
	        'cell': {
	          'index': +_index,
	    ...
	    console.log('just played a(n) ', currentPlayer, ' in index ', _index);
	    if (_over2) {
	      console.log('Game Over');
	    }
	    // hide board
	...
	module.exports = {
	  ...
	  onDispLayOneGame: onDispLayOneGame
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displayOneGame = function displayOneGame(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displayOneGameSuccess = function displayOneGameSuccess() {
	  console.log(data);
	  store.games = data.games;
	  var userGameArray = JSON.stringify(store.games);
	...
	var displayOneGameFailure = function displayOneGameFailure(error) {
	...
	module.exports = {
	  ...
	  displayOneGameSuccess: displayOneGameSuccess,
	  displayOneGameFailure: displayOneGameFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
